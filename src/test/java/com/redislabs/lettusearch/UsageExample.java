...
public class UsageExample {
	...
	public final static Schema SCHEMA = Schema.builder().field(Field.text(FIELD_NAME).matcher(PhoneticMatcher.English))
			.field(Field.tag(FIELD_STYLE).sortable(true)).field(Field.numeric(FIELD_ABV).sortable(true)).build();
