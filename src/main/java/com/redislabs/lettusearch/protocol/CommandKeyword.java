...
public enum CommandKeyword implements ProtocolKeyword {
	...
	INCR, KEEPDOCS, LOAD, APPLY, AS, FILTER, GROUPBY, REDUCE, COUNT, COUNT_DISTINCT, COUNT_DISTINCTISH, SUM, MIN, AVG,
	STDDEV, QUANTILE, TOLIST, FIRST_VALUE, RANDOM_SAMPLE, BY, DD, INKEYS, INFIELDS, RETURN, HIGHLIGHT, TAGS, WITHCURSOR,
