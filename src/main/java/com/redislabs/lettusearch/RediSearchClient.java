...
/**
 * A scalable and thread-safe <a href="http://redis.io/">Redis</a> client
 ...
 * </ul>
 *
 * Redis Cluster is used through
 * {@link io.lettuce.core.cluster.RedisClusterClient}. Upstream/Replica
 * connections through {@link MasterReplica} provide connections to Redis
 * Upstream/Replica ("Master/Slave") setups which run either in a static
