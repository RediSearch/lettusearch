...
image:https://img.shields.io/lgtm/alerts/g/RediSearch/lettusearch.svg?logo=lgtm&logoWidth=18["Total alerts", link="https://lgtm.com/projects/g/RediSearch/lettusearch/alerts/"]
endif::[]
