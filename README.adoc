...
image:https://github.com/actions/RediSearch/lettusearch/workflows/.github/workflows/gradle.yml/badge.svg["Actions", link="https://github.com/actions/RediSearch/lettusearch/workflows/.github/workflows/gradle.yml/badge.svg"]
